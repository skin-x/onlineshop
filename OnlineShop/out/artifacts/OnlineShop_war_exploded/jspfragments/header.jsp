			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
						...
						<li class="divider"></li>
						<li><a
							href="${pageContext.request.contextPath}/servlet/searchItemPageServlet?type=篮球鞋">篮球鞋</a></li>
						<li class="divider"></li>
						<li><a
							href="${pageContext.request.contextPath}/servlet/searchItemPageServlet?type=足球鞋">足球鞋</a></li>
						<li class="divider"></li>
						<li><a
							href="${pageContext.request.contextPath}/servlet/searchItemPageServlet?type=网球鞋">网球鞋</a></li>
					</ul></li>
			</ul>
		</div>
